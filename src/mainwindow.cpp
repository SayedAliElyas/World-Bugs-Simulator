                                         ...
                                         int fps)
{
    ...
    // Prompt user for trace length
    int traceLength = QInputDialog::getInt(this, "Trace Length",
                                           "Enter trace length (frames):",
                                           5, 1, 20, 1, &trace_checker);
    if (trace_checker) {
        view->setTraceLength(traceLength);
    }
